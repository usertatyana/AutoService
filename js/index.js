...
const formInfoData = document.querySelector('.form__info-date');
...
const init = () => {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            const response = await fetch('https://turquoise-literate-tiger.glitch.me/api/orders', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                alert('Данные успешно отпарвлены');
                form.innerHTML = `<h2>Данные успешно отпарвлены</h2>`
            } else {
